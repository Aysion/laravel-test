...
<table class="table">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				@if (Auth::user()->can('user-form', $item) && !$item->deleted_at)
			...
			<td>
				@if (Auth::user()->can('user-enable', $item) && $item->deleted_at)
				...
				@elseif(Auth::user()->can('user-delete', $item))
